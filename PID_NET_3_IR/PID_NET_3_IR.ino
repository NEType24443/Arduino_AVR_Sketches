...
#define LEDG  13
                    //5,6 is 980Hz and 9, 11 are 490
#define MOT1  5
#define MOT2  9   //swap pins of mot2 and mot 3 because of timer issues
#define MOT3  6
#define MOT4  11
...
#define PRESS         0
#define RELEASE       1
#define CAL_SPEED     375   //Sensor calibration speed
...
unsigned long ms = 0;
const int SENSOR[N_SENS] = {A1, A2, A3};     //Arduino pins
